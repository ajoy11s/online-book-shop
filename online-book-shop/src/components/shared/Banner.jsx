...
function Banner() {
  return (
    ...
    <div className="text-center flex flex-col gap-2">
        <h3 className="font-extrabold text-4xl text-green-500">Unlock a World of  Stories</h3>

        <h4 className="font-semibold text-2xl text-gray-400"> Find Your Next Favorite Book at -</h4>

        <h2 className="font-semibold text-5xl text-green-400">Online Book Shop</h2>
